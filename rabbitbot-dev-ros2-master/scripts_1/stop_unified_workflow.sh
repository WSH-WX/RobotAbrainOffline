...
#
# 说明：
#   1. 停止普通统一容器和统一无机器人模式容器内的 workflow 及后台服务。
...
PROJECTS_DIR="${RABBITBOT_PROJECTS_DIR:-$(cd "${RABBITBOT_REPO_DIR}/.." && pwd)}"
...
HOST_NAV_EXAMPLE_DIR="${HOST_NAV_EXAMPLE_DIR:-${PROJECTS_DIR}/unitree_slam_example_new/example}"
