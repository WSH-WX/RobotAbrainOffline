...
start_tts() {
    ...
    log_info "TTS 启动配置：后端=${RABBITBOT_TTS_BACKEND}，音频后端=${RABBITBOT_TTS_AUDIO_BACKEND}，Pulse=${RABBITBOT_ENABLE_PULSE_AUDIO}，Unitree 网卡=${RABBITBOT_UNITREE_TTS_INTERFACE}，音量=${RABBITBOT_UNITREE_TTS_VOLUME}"
